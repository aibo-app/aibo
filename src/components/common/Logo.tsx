...
export const Logo: React.FC<{ className?: string }> = ({ className }) => (
    <svg viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        ...
        <g transform="translate(0, 12)">
            <rect x="62" y="4" width="4" height="25" rx="2" fill="currentColor" />
            <circle cx="64" cy="4" r="6" fill="currentColor" />
            <path fillRule="evenodd" clipRule="evenodd"
                ...
                fill="currentColor"
            />
            <rect x="24" y="36" width="80" height="56" rx="4" fill="currentColor" mask="url(#feature-mask)" />
        </g>
    </svg>
);
